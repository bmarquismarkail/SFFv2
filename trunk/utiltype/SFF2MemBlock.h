...
class SFF2MemBlock
{
    public:
        SFF2MemBlock();
        SFF2MemBlock(std::ifstream *in, SFF32_u Ofs, SFF32_u Len);
        ~SFF2MemBlock();
        ...
        void ReadDataFromDisk(std::ifstream *in, SFF32_u Ofs, SFF32_u Len);
        void TranslateDataFromDisk(std::ifstream *in, SFF32_u Ofs, SFF32_u SrcLen, SFF32_u DstLen, SFF16_u Fmt);
